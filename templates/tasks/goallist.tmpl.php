...
<?$x=0; foreach($goallist as $goallist=>$v):?>
        <tr bgcolor="#<? echo ($x % 2 == 0) ? "BBBBBB" : "AAAAAA";?>">
          ...
          <td align="center" width="20%"><a href="index.php?editor=items&tskid=<?=$id?>&id=<?=$v['entry']?>&action=2"></a><?=get_item_name($v['entry'])?> <span>[<a href="http://192.168.0.25:8090/item/<?=$v['entry']?>" target="_blank">Spire</a>]</span></td>
          <td align="right">   
